...
Public Class Container
    ...
    Private Sub TroubleshootingGuideToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TroubleshootingGuideToolStripMenuItem.Click
        Dim frm As New TroubleShootingGuide()
        frm.MdiParent = Me
        frm.Show()
    End Sub
